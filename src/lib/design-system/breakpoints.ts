...
export const mediaQueries = {
  ...
  mobile: {
    ...
    down: (size: keyof typeof breakpoints.mobile) => `@media (max-width: ${breakpoints.mobile[size] - 1}px)`,
    only: (size: keyof typeof breakpoints.mobile) => {
      ...
      return `@media (min-width: ${minWidth}) and (max-width: ${maxWidth - 1}px)`;
    }
  },
  
  tablet: {
    up: (size: keyof typeof breakpoints.tablet) => `@media (min-width: ${breakpoints.tablet[size]})`,
    down: (size: keyof typeof breakpoints.tablet) => `@media (max-width: ${breakpoints.tablet[size] - 1}px)`,
  ...
  desktop: {
    ...
    down: (size: keyof typeof breakpoints.desktop) => `@media (max-width: ${breakpoints.desktop[size] - 1}px)`,
  ...
  between: (min: keyof typeof breakpointValues, max: keyof typeof breakpointValues) => 
    `@media (min-width: ${breakpointValues[min]}) and (max-width: ${breakpointValues[max] - 1}px)`,
} as const;

// Device category detection
export const deviceCategories = {
  mobile: `@media (max-width: ${breakpoints.tablet.sm - 1}px)`,
  tablet: `@media (min-width: ${breakpoints.tablet.sm}) and (max-width: ${breakpoints.desktop.sm - 1}px)`,
