...
const example = (isTr: boolean): ExampleProject => {
  ...
  const switch0State = createInitialState('00:1A:2B:3C:A4:80', 'WS-C2960-24TT-L');
  ...
  const mlSwitch1State = createInitialState('00:1A:2B:3C:A4:00', 'WS-C3650-24PS');
  ...
  const router3State = createInitialRouterState('00:50:00:00:A4:10');
  ...
  router3State.dynamicRoutes = [
    { destination: '10.0.0.0', subnetMask: '0.0.0.255', nextHop: 'directly connected', metric: 1, type: 'dynamic', area: 0 },
    { destination: '20.0.0.0', subnetMask: '0.0.0.255', nextHop: 'directly connected', metric: 1, type: 'dynamic', area: 20 }
  ];
  ...
  const mlSwitch2State = createInitialState('00:1A:2B:3C:A4:40', 'WS-C3650-24PS');
  ...
  mlSwitch2State.dynamicRoutes = [
    { destination: '20.0.0.0', subnetMask: '0.0.0.255', nextHop: 'directly connected', metric: 1, type: 'dynamic', area: 20 },
    { destination: '192.168.2.0', subnetMask: '0.0.0.255', nextHop: 'directly connected', metric: 1, type: 'dynamic', area: 20 }
  ];
  ...
  const switch1State = createInitialState('00:1A:2B:3C:A4:C0', 'WS-C2960-24TT-L');
