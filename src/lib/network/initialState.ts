...
function createInitialPorts(gigabitPortCount: number = 2, baseMac?: string): Record<string, Port> {
...
export function createInitialState(mac?: string, switchModel: 'WS-C2960-24TT-L' | 'WS-C3650-24PS' = 'WS-C2960-24TT-L'): SwitchState {
  ...
  const ports = createInitialPorts(switchLayer === 'L3' ? 4 : 2, macAddress);
...
export const commandAliases: Record<string, string> = {
  ...
  // Port-security aging
  'sw p a': 'switchport port-security aging',
  'sw po a': 'switchport port-security aging',
  'sw por a': 'switchport port-security aging',
  'sw port a': 'switchport port-security aging',
  'sw port-s a': 'switchport port-security aging',
  'switchport port-security a': 'switchport port-security aging',
  'switchport port-security ag': 'switchport port-security aging',
  'switchport port-security agi': 'switchport port-security aging',
  'switchport port-security agin': 'switchport port-security aging',
  'switchport port-security aging': 'switchport port-security aging',
  'switchport port-security aging t': 'switchport port-security aging time',
  'switchport port-security aging ti': 'switchport port-security aging time',
  'switchport port-security aging tim': 'switchport port-security aging time',
  'switchport port-security aging time': 'switchport port-security aging time',
  'switchport port-security aging ty': 'switchport port-security aging type',
  'switchport port-security aging typ': 'switchport port-security aging type',
  'switchport port-security aging type': 'switchport port-security aging type',
  ...
  'no vlan': 'no vlan',
  'no sw': 'no switchport',
  'no swi': 'no switchport',
  'no swit': 'no switchport',
  'no switc': 'no switchport',
  'no switch': 'no switchport',
