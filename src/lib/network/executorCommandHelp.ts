...
export const commandHelp: Record<string, Record<string, string[]>> = {
  'user': {
    ...
    'show ip': ['arp', 'interface', 'nat', 'ospf', 'protocols', 'route', 'sla'],
  ...
  'privileged': {
    ...
    'show interface': ['trunk'],
    'show interfaces': ['status', 'trunk'],
    'show ip': ['arp', 'bgp', 'dhcp', 'eigrp', 'interface', 'nat', 'ospf', 'protocols', 'route', 'sla', 'source', 'ssh', 'verify'],
    'show ip sla': ['statistics'],
    'show class-map': ['<name>'],
    ...
    'show ip verify source': [],
    'show ipv6': ['dhcp', 'interface', 'neighbors', 'ospf', 'rip', 'route'],
    'show ipv6 dhcp': ['pool'],
    'show ipv6 interface': ['brief'],
    'show ipv6 ospf': [],
    'show ipv6 rip': [],
  ...
  'config': {
    '': ['access-list', 'alias', 'ap', 'archive', 'banner', 'cdp', 'channel', 'class-map', 'clock', 'crypto', 'default', 'do', 'dot11', 'dot1x', 'enable', 'end', 'errdisable', 'exit', 'hostname', 'interface', 'ip', 'ipv6', 'lldp', 'line', 'mac', 'macro', 'mls', 'monitor', 'no', 'ntp', 'policy-map', 'router', 'same-security-traffic', 'sdm', 'security', 'service', 'snmp-server', 'spanning-tree', 'station-role', 'system', 'template', 'username', 'vlan', 'vtp', 'wlan'],
    ...
    ...pfx('ip', ['access-list', 'arp', 'default-gateway', 'dhcp', 'domain', 'domain-lookup', 'domain-name', 'host', 'http', 'name-server', 'nat', 'route', 'routing', 'sla', 'ssh']),
    'ip arp': ['inspection'],
  ...
  'interface': {
    '': ['bandwidth', 'carrier-delay', 'cdp', 'channel-group', 'channel-protocol', 'delay', 'description', 'do', 'dot1x', 'duplex', 'encapsulation', 'encryption', 'end', 'exit', 'help', 'ip', 'ipv6', 'keepalive', 'lldp', 'load-interval', 'macro', 'mls', 'nameif', 'no', 'power', 'priority-queue', 'queue-set', 'security-level', 'service-policy', 'shutdown', 'spanning-tree', 'speed', 'ssid', 'storm-control', 'switchport', 'tx-queue', 'udld'],
    ...pfx('cdp', ['enable']),
    ...pfx('clock', ['rate']),
    ...pfx('do', ['show']),
