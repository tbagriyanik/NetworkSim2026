...
export const commandHelp: Record<string, Record<string, string[]>> = {
  ...
  'dot11-config': {
    '': ['channel', 'encryption', 'mac-filter', 'power', 'ssid', 'station-role'],
    ...pfx('channel', []),
    ...pfx('encryption', ['mode']),
    'encryption mode': ['ciphers'],
    ...pfx('mac-filter', []),
    ...pfx('no', ['channel', 'mac-filter']),
    ...pfx('power', []),
    ...pfx('ssid', []),
    ...pfx('station-role', []),
  },
