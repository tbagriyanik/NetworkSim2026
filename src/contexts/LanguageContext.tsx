...
const translations: Record<Language, Translations> = {
  ...
  en: {
    ...
    dontSave: 'Don\'t Save',
    dragToZoomOrScroll: 'Drag to zoom or scroll; single click to return to 100%.',
    ...
    tutorialReadyDesc: 'You\'re now ready to start network simulation! We recommend completing the guided lessons to build foundational skills. Explore example projects or create your own topology. Help panel (bottom-right) and command reference are always available. Good luck!',
    tutorialReadyTitle: '🚀 You\'re Ready!',
    tutorialThemeDesc: 'Set Dark/Light theme (🌙/☀️) and language (🇹🇷/🇬🇧) preferences. Toggle graphics quality between low/high. All preferences are automatically saved in the browser.',
    tutorialThemeTitle: '🎨 Interface Customization',
    tutorialTopologyDesc: 'Drag and drop to position devices. To connect: 1) Click the Connect button, 2) Select source device/port, 3) Select target device/port. Double-click: Opens CMD on PC, CLI on Switch/Router.',
