...
const translations: Record<Language, Translations> = {
  tr: {
    ...
    addWLC: 'WLC',
    addL2Switch: 'L2 Switch',
    addL3Switch: 'L3 Switch',
    addNote: 'Not',
    addPC: 'PC',
    addPc: 'PC',
    ...
    addPool: 'Havuz',
    addRouter: 'Router',
    addRouterShort: 'Router',
    addSwitch: 'Switch',
    addSwitchShort: 'Switch',
    ...
    clickIconsToRun: 'Program çalıştırmak için simgelere tıklayınız',
    clientsLeased: 'istemci kiralandı',
    close: 'Kapat',
    closed: 'Kapalı',
    ...
    dontSave: 'Kaydetme',
    dragToZoomOrScroll: 'Sürükleyerek yakınlaştırın, tek tıklama ile %100 seviyesine sıfırlanır.',
    ...
    tutorialWizard: 'Rehberli Ders',
    wizardSupported: 'Rehber Destekli',
    ...
    simulatorTitle: 'Network Simulator',
    sizeLabel: 'Boyut',
    ...
    tutorialReadyDesc: 'Artık ağ simülasyonuna başlamaya hazırsınız! Rehberli dersleri tamamlayarak temel becerileri kazanmanızı öneririz. Örnek projeleri inceleyin veya kendi topolojinizi oluşturun. Yardım paneli (sağ alt köşe) ve komut referansı her zaman yanınızda. İyi çalışmalar!',
    ...
    uncomplete: 'Geri Al (Tamamlanmadı)',
    undo: 'Geri Al',
  ...
  en: {
    about: 'Help',
    aboutIntro: 'This app is an interactive simulation tool designed for those who want to learn network technologies and terminal commands.',
    aboutTitle: 'About',
    ...
    back: 'Back',
    backgroundGreenhouse: 'Greenhouse Layout',
    backgroundHouse: 'House Layout',
    backgroundNone: 'None',
    backgroundTwoStoryGarage: '2-Story Building',
    basicCommands: 'Basic commands',
    basicHint: 'Basic commands and initial topology steps',
    bathroom: 'Bathroom',
    bedroom: 'Bedroom',
    beginner: 'Beginner',
    ...
    dontSave: 'Don\'t Save',
    dragToZoomOrScroll: 'Drag to zoom, single click resets to 100%.',
    ...
    httpServiceDescription: 'When HTTP is enabled, web content for this device is published.',
    humidity: 'Humidity',
    id: 'ID',
    idle: 'Idle',
    ...
    invalidDnsAddress: 'Please enter a valid DNS address.',
    invalidGatewayAddress: 'Please enter a valid gateway address.',
    invalidIpv4Address: 'Please enter a valid IPv4 address.',
    invalidIpv6Address: 'Please enter a valid IPv6 address.',
    invalidProject: 'Error',
    invalidProjectFile: 'Invalid project file',
    invalidSubnetMask: 'Please enter a valid subnet mask.',
    ...
    next: 'Next',
    no: 'No',
    noCommandsAvailable: 'No quick commands available in this mode',
    ...
    noWifiDevices: 'No WiFi devices found',
    ...
    openNewProjectDesc: 'Select a preset scenario or start with an empty project to begin designing your topology.',
    ...
    pcConnectionClosed: 'Connection closed by remote computer.',
    ...
    pcNotConnected: 'Not connected to any switch or router',
    ...
    pools: 'Pools',
    portClickTip: 'Port LED indicator',
    portInUse: 'This port is already in use!',
    portName: 'Name',
    portSecurityBlocked: 'Port Security: X blocked, Y opened',
    ...
    pressTabToCycle: 'Press Tab for more ({count} options)',
    ...
    tutorialWizard: 'Guided Lessons',
    wizardSupported: 'Guide Supported',
    ...
    routerInfoPanel: 'Router Info Panel',
    routing: 'Routing',
    ...
    tabDescCmd: 'Execute commands like ping, ipconfig in PC Command Prompt (CMD).',
    tabDescTasks: 'Complete port, VLAN, and security tasks to earn points.',
    ...
    tour: 'Tour',
    turkish: 'Türkçe',
    tutorialCablesDesc: 'Cable types: Straight (PC↔Switch/Router), Crossover (Switch↔Switch / Router↔Router), Console (PC↔Device configuration connections).',
    tutorialCablesTitle: '🔌 Cable Types',
    tutorialDevicesDesc: 'Power devices on/off, configure (CLI/Panel), and monitor. Perform configuration via command line in CLI tab. Complete VLAN, port, and security tasks in Tasks tab.',
    tutorialDevicesTitle: '💻 Device Management',
    tutorialPingDesc: 'Test connectivity between devices using Ping mode. Successful pings are shown in green, failed ones in red animation. Configure DHCP for automatic IP assignment or static IP manually.',
    tutorialPingTitle: '📡 Ping and Connectivity Testing',
    tutorialProjectDesc: 'Save projects (Ctrl+S), load (Ctrl+O), or start new (Alt+N). Explore ready scenarios with sample projects. All configurations are saved in JSON format.',
    tutorialProjectTitle: '💾 Project Management',
    tutorialReadyDesc: 'You are ready to start network simulation! We recommend completing guided lessons to learn basic skills. Inspect sample projects or create your own topology. The help panel (bottom right) and command reference are always available. Good luck!',
    tutorialReadyTitle: '🚀 You\'re Ready!',
    tutorialThemeDesc: 'Adjust Dark/Light theme (🌙/☀️) and language (🇹🇷/🇬🇧) preferences. Toggle graphics quality between low and high. All preferences are automatically saved in the browser.',
    tutorialThemeTitle: '🎨 Interface Customization',
    tutorialTopologyDesc: 'Drag and drop to place devices. To connect: 1) Click Connect button, 2) Select source device/port, 3) Select target device/port. Double-click: Opens CMD on PC, CLI on Switch/Router.',
    ...
    tutorialWifiDesc: 'Set Routers and Switches to Access Point mode (WiFi settings). Configure SSID, encryption (WPA2/WPA3), and password. PCs will automatically connect to access points.',
    ...
    vTaskMultipleDesc: 'VLAN with at least 3 users',
    vTaskMultipleName: 'Multiple VLANs',
    vTaskNameDesc: 'Name a VLAN',
    vTaskNameName: 'Name VLAN',
    vTaskTrunkDesc: 'Set a port to trunk mode',
    vTaskTrunkName: 'Trunk Port',
    ...
    vlanOnlyOnNetworkDevices: 'VLAN info can only be viewed and configured on switch or router devices.',
    ...
    wirelessClientsConnected: 'X wireless client(s) connected',
    ...
    intermediateLevel: 'Intermediate (Error Hints Only)',
    advanced: 'Advanced Level',
    advancedLevel: 'Advanced (No Hints)',
    basarilarim: 'My Achievements',
    basarilarimEmpty: 'No achievements recorded yet. Complete guided lessons, take exams, and save projects to see your achievements here.',
    ...
    selectStartConnectionPort: 'Select the starting port for connection',
    selectCompleteConnectionPort: 'Select the target port to complete connection',
    ...
    clearCapture: 'Clear',
    clearAllCapture: 'Clear All Captured Packets',
