  ...
  return [
    ...
    },
    {
      ...
      cmds: [
        ...
        ['ip dhcp snooping vlan <ids>', isTR ? 'VLANlarda DHCP snooping' : 'DHCP snooping on VLANs'],
    ...
    },
    {
      ...
      cmds: [
        ...
        ['switchport trunk encapsulation dot1q', isTR ? 'Trunk kapsülleme' : 'Trunk encapsulation'],
        ['encapsulation dot1q <vlan>', isTR ? 'Subinterface VLANı' : 'Subinterface VLAN'],
        ...
        ['switchport port-security aging time <n>', isTR ? 'Güvenlik yaşlanma süresi' : 'Port-security aging time'],
        ['no switchport port-security', isTR ? 'Güvenliği kapat' : 'Disable port security'],
        ['switchport protected', isTR ? 'Korumalı port' : 'Protected port'],
        ['switchport block {unicast|multicast}', isTR ? 'Trafik bloklama' : 'Block traffic'],
