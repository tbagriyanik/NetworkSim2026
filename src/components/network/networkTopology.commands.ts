  ...
  return [
    ...
    },
    {
      ...
      cmds: [
        ...
        ['mail <recipient>', isTR ? 'E-posta gönder' : 'Send email', '#'],
    ...
    },
{
    ...
    },
    {
      id: 'vip',
      icon: Shield,
      title: isTR ? 'VIP Modu' : 'VIP Mode',
      type: 'commands',
      cmds: [
        ['vip mode', isTR ? 'VIP moduna geç' : 'Enter VIP mode'],
        ['vip configure <parameter>', isTR ? 'VIP parametrelerini ayarla' : 'Configure VIP parameter'],
        ['no vip configure', isTR ? 'VIP yapılandırmasını sil' : 'Remove VIP configuration'],
        ['vip status', isTR ? 'VIP durumunu göster' : 'Show VIP status'],
        ['vip diagnostic', isTR ? 'VIP teşhis' : 'VIP diagnostic'],
        ['vip access-list <name>', isTR ? 'VIP güvenlik listesi' : 'VIP access list'],
        ['vip authentication', isTR ? 'VIP kimlik doğrulama' : 'VIP authentication'],
        ['vip session <id>', isTR ? 'VIP oturumunu yönet' : 'Manage VIP session'],
        ['vip reboot', isTR ? 'VIP yeniden başlat' : 'VIP reboot'],
        ['vip system-info', isTR ? 'VIP sistem bilgisi' : 'VIP system info'],
        ['vip logging <level>', isTR ? 'VIP log seviyesi' : 'VIP logging level'],
        ['vip user <name>', isTR ? 'VIP kullanıcı oluştur' : 'Create VIP user'],
        ['vip role <role>', isTR ? 'VIP rolü atala' : 'Assign VIP role'],
        ['vip permission <command>', isTR ? 'VIP yetki ver' : 'Grant VIP permission'],
        ['vip timeout <time>', isTR ? 'VIP zaman aşımı' : 'VIP timeout'],
        ['vip backup', isTR ? 'VIP yedekle' : 'VIP backup'],
        ['vip restore', isTR ? 'VIP geri yükle' : 'VIP restore'],
        ['vip monitor', isTR ? 'VIP monitörünü aç' : 'Enable VIP monitor'],
        ['vip secure', isTR ? 'VIP güvenli mod' : 'Enable VIP secure mode'],
        ['vip hot-backup', isTR ? 'VIP sıcak yedek' : 'Configure VIP hot backup'],
        ['vip cluster <name>', isTR ? 'VIP küme oluştur' : 'Configure VIP cluster'],
        ['vip heartbeat <interval>', isTR ? 'VIP heartbeat aralığı' : 'Configure VIP heartbeat'],
        ['vip failover', isTR ? 'VIP failover' : 'Configure VIP failover'],
        ['vip management', isTR ? 'VIP yönetim' : 'VIP management'],
        ['vip health', isTR ? 'VIP sağlık kontrolü' : 'VIP health check'],
        ['vip alert', isTR ? 'VIP alarm' : 'VIP alert'],
        ['vip statistics', isTR ? 'VIP istatistikleri' : 'VIP statistics'],
        ['vip maintenance', isTR ? 'VIP bakım modu' : 'VIP maintenance mode'],
        ['vip service-policy', isTR ? 'VIP hizmet politikası' : 'VIP service policy'],
        ['vip bandwidth <value>', isTR ? 'VIP bant genişliği' : 'VIP bandwidth'],
        ['vip qos', isTR ? 'VIP QoS' : 'VIP QoS'],
        ['vip acceleration', isTR ? 'VIP hızlandırma' : 'VIP acceleration'],
        ['vip encryption', isTR ? 'VIP şifreleme' : 'VIP encryption'],
        ['vip authentication', isTR ? 'VIP kimlik doğrulaması' : 'VIP authentication'],
        ['vip authorization', isTR ? 'VIP yetkilendirme' : 'VIP authorization'],
        ['vip accounting', isTR ? 'VIP muhasebe' : 'VIP accounting'],
        ['vip auditing', isTR ? 'VIP denetim' : 'VIP audit'],
        ['vip compliance', isTR ? 'VIP uyumluluk kontrolü' : 'VIP compliance check'],
        ['vip firewall', isTR ? 'VIP güvenlik duvarı' : 'VIP firewall'],
        ['vip intrusion-prevention', isTR ? 'VIP saldırı önleme' : 'VIP intrusion prevention'],
        ['vip malware-protection', isTR ? 'VIP kötü amaçlı yazılım koruması' : 'VIP malware protection'],
        ['vip data-loss-prevention', isTR ? 'VIP veri kaybı önleme' : 'VIP data loss prevention'],
        ['vip san-zone', isTR ? 'VIP SAN alanı' : 'VIP SAN zone'],
        ['vip export-policy', isTR ? 'VIP dışa aktarma politikası' : 'VIP export policy'],
        ['vip import-policy', isTR ? 'VIP içe aktarma politikası' : 'VIP import policy'],
      ]
    },
    {
      id: 'administration',
