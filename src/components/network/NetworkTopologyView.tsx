                  ...
                  >
                    <div
                      ...
                      style={{
                        background: (() => {
                          ...
                          return gradientMap[note.color] || note.color;
                        })(),
                    ...
                    >
                      <div
                        ...
                        className={`flex items-center justify-between px-2 text-[10px] font-semibold tracking-widest cursor-grab active:cursor-grabbing select-none ${isDark ? 'bg-black/10' : 'bg-black/5'
                          }`}
