...
export function NetworkCanvas({
    ...
    const alignDevices = (deviceIds: string[], alignment: string) => {
        ...
        const alignmentType: 'left' | 'center' | 'right' | 'top' | 'middle' | 'bottom' | 'distribute-h' | 'distribute-v' = alignment as 'left' | 'center' | 'right' | 'top' | 'middle' | 'bottom' | 'distribute-h' | 'distribute-v';
